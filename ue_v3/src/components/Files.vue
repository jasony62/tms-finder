<template>
  <div class="files">
    ...
    <el-table ref="multipleTableRef" :data="files" stripe style="width: 100%" @row-dblclick="rowDbClick" v-if="viewStyle === '1'">
    ...
    <el-drawer v-model="drawer" title="I am the title" :with-header="false">
      <div v-for="p in pluginList" style="margin-top: 10px">
        <el-button v-if="p.transData==='nothing'" type="success" plain @click="handlePlugin(p)">{{p.title}}</el-button>
        <el-dropdown v-else>
