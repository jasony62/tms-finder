  ...
  <div class="info">
    <tms-flex direction="column" :gap="gap" alignItems="stretch">
      ...
      <tms-flex class="tms-pagination">
        <el-pagination background v-model:currentPage="batch.page" :page-sizes="[10, 20, 30]"
          v-model:pageSize="batch.size" layout="total, sizes, prev, pager, next" :total="batch.total"></el-pagination>
      </tms-flex>
    </tms-flex>
  </div>
</template>
...
const columns = 9
const cardClass = 'el-card'
const emptyClass = 'empty-card'
